...
- **[06 — Consumo de API de ARESEP](06-scraping-aresep/README.md)**: descarga del histórico de datos de agua potable desde la API de datos abiertos.
...
Los proyectos del sistema IMN (01-05) forman parte de un sistema que captura y acumula datos de ~50 estaciones meteorológicas del IMN. El IMN publica cada estación en una tabla HTML sin API, y mantiene solo una ventana móvil de ~24 horas. El sistema respalda y acumula los datos diariamente para construir series históricas propias.

El proyecto 06 consume una API de datos abiertos de ARESEP, independiente del sistema IMN.
